...
public class BillboardCylindrical extends Billboard{
	
	public BillboardCylindrical(Texture texture, Vector3 position, Vector2 size) {
		super (texture, position, size, false);
	}
	
	public BillboardCylindrical(Texture texture, Vector3 position, Vector2 size, boolean flip) {
